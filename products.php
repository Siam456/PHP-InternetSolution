...
<header>
      <div class="container-fluid"  style="display: flex;background-color:black">
        <h6 style="padding: 11px; color: aliceblue; font-size: 14px;">Welcome to Amber IT</h6>
...
<nav class="navbar navbar-expand-sm navbar-light bg-light sticky-top">
        <div class="container-fluid">
            <a href="home.html" class="navbar-brand"><h3>INTERNET<span style="color: #C71F2B;">SOLUTION</span></h3></a>
