...
if (isset($_POST['remove']) != ''){
    ...
    $remove = "DELETE FROM package_request WHERE id='$id'";
...
<body>
    ...
    <h2 class="text-center">REQUEST FOR PACKAGES APPEAR HERE</h2><hr><hr>
    ...
    <table class="table table-bordered table-striped table-hover my-5 p-2">
                    ...
                    <tbody>
                    <?php
                    $sql = "SELECT * FROM package_request";
