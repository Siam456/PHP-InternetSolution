...
?>
    <div class="container my-3">
        <h2 class="text-center">RESPONSE TO QUICK SERVICE ON URGENT BASIS</h2>
        <small class="text-center text-danger d-block mx-auto">DO NOT FORGET TO UPDATE THE STATUS</small>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="../quickservice/qsc_update.php" method="POST">
